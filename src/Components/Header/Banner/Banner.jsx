                ...
                <div className="searchbar absolute bottom-[40%] w-full px-20">
                    <form>
                        <div className="relative">
                            <div className="p-6">
                                <h2 className="text-3xl md:text-5xl font-bold text-[#0B0B0B]">I Grow By Helping People In Need</h2>
                                <input className="mt-4 p-4 rounded-l-lg md:w-[360px] border border-solid border-[#11111126]" type="text" placeholder="Search here...." />
